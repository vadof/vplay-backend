...
@Slf4j
public class GenericAuthFilter implements GatewayFilter {

    private final JwtUtil jwtUtil;
    private final Predicate<String> securedPredicate;

    public GenericAuthFilter(JwtUtil jwtUtil, Predicate<String> securedPredicate) {
        this.jwtUtil = jwtUtil;
        this.securedPredicate = securedPredicate;
    }
